...
<html>
	...
	<?php
		if(isset($_POST["recipient"]) && isset($_POST["msg"]) && isset($_POST["subject"])) {
			$mail = new PHPMailer;
			...
			$mail->Username = 'sebastian-mandl@gmx.net';          // SMTP username
			$mail->Password = '';                         // SMTP password
			$mail->SMTPSecure = 'tls';                            // Enable encryption, 'ssl' also accepted

			$mail->From = 'sebastian-mandl@gmx.net';
	...
	$handle = imap_open("{imap.gmx.net/imap2/ssl}INBOX", "sebastian-mandl@gmx.net", "");
